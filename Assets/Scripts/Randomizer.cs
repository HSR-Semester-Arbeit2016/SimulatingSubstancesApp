...
namespace Assets.Scripts
{
    public class Randomizer
    {
        ...
        /// <param name="totalMin">
        ///     The absolute minimum that may be reached (usually given by the underlying component of the
        ///     initial value).
        /// </param>
        /// <param name="totalMax">
        ///     The absolute maximum that may be reached (usually given by the underlying component of the
        ///     initial value).
        /// </param>
        /// <param name="rangeIncrementPercentage">
        ///     The percentage of the total possible values that should be used to calculate the boundaries of the RandomWalk.
        ///     10(%) means the boundaries will be set to initial value +-10% of the totally available values (totalMax-totalMin)
        ///     and all values in between may be reached at some point.
        /// </param>
        /// <param name="stayProbability">
        ///     The probability as percentage for the calculated value to stay the same on a
        ///     RandomWalk-step.
        /// </param>
        /// <param name="rangeSplits">
        ///     The amount of steps that should be possible within the calculated boundaries. This
        ///     essentially defines the size of a possible in- or de-crementation on a RandomWalk-step.
        /// </param>
        ...
        /// <summary>
        ///     Calculates and applies the next value using the currentValue and the corresponding boundary as well as the globally
        ///     defined limitations.
        /// </summary>
        ...
        ///     Depending on where in that range the calculated value lands in comparison to the currentValue, this function will
        ///     then return 0, +1 or -1
        /// </summary>
        /// <param name="currentValue">The value currently in use on which the RandomWalk shall be performed.</param>
