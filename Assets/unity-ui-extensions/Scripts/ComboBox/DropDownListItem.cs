...
namespace UnityEngine.UI.Extensions
{
	...
	public class DropDownListItem
	{
		...
		public DropDownListItem (string caption = "", string filePath = "", string inId = "", Sprite image = null, bool disabled = false, Action onSelect = null)
		{
			_caption = caption;
			_image = image;
			_id = inId;
